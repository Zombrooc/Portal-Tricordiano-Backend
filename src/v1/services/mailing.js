...
const mailOptions = {
  from: `"The Simple TECH" <${process.env.NODE_MAILER_USER}>`,
  replyTo: process.env.NODE_MAILER_USER,
}
...
const verificationEmail = async (name, userEmail, validationToken) => {
  let link = `${process.env.APP_FRONTEND_URL}/auth/confirm-email?token=${validationToken}`
                                                      ...
                                                      <tr>
                                                        ...
                                                        >
                                                          <img
                                                            ...
                                                            src="https://i.imgur.com/lPfXZv0.png"
                                                          />
                                                        </td>
                                                      </tr>
                                                    </tbody>
                                                            ...
                                                            >
                                                              <span
                                                                style="
                                                                  font-size: 43px;
                                                                "
                                                                >Obrigado por se cadastrar, <%= USER.username %> </span
                                                              >
                                                            </div>
                                                            <div></div>
                                                          </div>
                                                            ...
                                                            >
                                                              <span
                                                                style="
                                                                  font-size: 18px;
                                                                "
                                                                >Por favor, verifique seu email para</span
                                                              ><span
                                                                style="
                                                                  color: #000000;
                                                                  font-size: 18px;
                                                                ...
                                                                "
                                                              >
                                                                ter acesso ao nosso conteúdo</span
                                                              ><span
                                                                style="
                                                                  font-size: 18px;
                                                                "
...
const forgotPassword = async ({ userEmail, forgotPassToken }) => {
  let link = `${process.env.APP_FRONTEND_URL}/auth/forgot_password?token=${forgotPassToken}`
                                                                ...
                                                                >
                                                                  <span
                                                                    style="
                                                                      font-size: 18px;
                                                                    "
                                                                    >Uma solicitação para a recuperação da sua senha foi gerado, clique no botão abaixo para trocar sua senha, se não fez isso apenas desconsidere essa mensagem.</span
                                                                  >
                                                                </div>
